...
public struct TableKeys {
  ...
  static func populate(withUser user: FMUser) -> [[String: Any]] {
    return [
      [
        TableKeys.Rows: [
          [TableKeys.ImageName: user.AvaterString, TableKeys.Title: user.name, TableKeys.SubTitle: "View your profile"]
        ]
      ],
      [
        TableKeys.Rows: [
